! function() {
    ...
    function nr(n) {
        ...
        function e(t) {
            return rr(t, function(e, r) { e = n(e, r), t.point(e[0], e[1]) })
        }
    ...
    function or(n) {
        return rr(n, function(t, e) { n.point(t * Da, e * Da) })
    }
    ...
    var ta = { version: "3.5.6" },
        ...
        ua = this.document;
    if (ua) try { ra(ua.documentElement.childNodes)[0].nodeType } catch (ia) {
        ra = function(n) {
    ...
    if (Date.now || (Date.now = function() {
            return +new Date
        }), ua) try { ua.createElement("DIV").style.setProperty("opacity", 0, "") } catch (oa) {
    ...
    c(l, {
        ...
        function n(t, o, a) {
            ...
            return t ? (s = t(), f = function(e, r) { s.set(e, n(t, r, a)) }) : (s = {}, f = function(e, r) { s[e] = n(t, r, a) }), d.forEach(f), s
        }
    ...
    var ma = /[\\\^\$\*\+\?\|\[\]\(\)\.\{\}]/g,
        ya = {}.__proto__ ? function(n, t) { n.__proto__ = t } : function(n, t) {
    ...
    ta.interpolateZoom = function(n, t) {
        ...
        function g() {
            ...
            y ? clearTimeout(y) : (Dl.call(this), v = e(d = m || ta.mouse(this)), c(n)), y = setTimeout(function() { y = null, s(n) }, 50), S(), u(Math.pow(2, .002 * Ha()) * k.k), i(d, v), l(n)
        }
    ...
    }, ta.timer.flush = function() { Lt(), Tt() }, ta.round = function(n, t) {
    ...
    jt.prototype = {
        ...
        setDate: function() { lc.setUTCDate.apply(this._, arguments) },
        setDay: function() { lc.setUTCDay.apply(this._, arguments) },
        setFullYear: function() { lc.setUTCFullYear.apply(this._, arguments) },
        setHours: function() { lc.setUTCHours.apply(this._, arguments) },
        setMilliseconds: function() { lc.setUTCMilliseconds.apply(this._, arguments) },
        setMinutes: function() { lc.setUTCMinutes.apply(this._, arguments) },
        setMonth: function() { lc.setUTCMonth.apply(this._, arguments) },
        setSeconds: function() { lc.setUTCSeconds.apply(this._, arguments) },
        setTime: function() { lc.setTime.apply(this._, arguments) }
    };
    ...
    var vc = {
            Feature: function(n, t) { se(n.geometry, t) },
        ...
        dc = {
            ...
            LineString: function(n, t) { fe(n.coordinates, t, 0) },
            MultiLineString: function(n, t) {
                for (var e = n.coordinates, r = -1, u = e.length; ++r < u;) fe(e[r], t, 0)
            },
            Polygon: function(n, t) { he(n.coordinates, t) },
    ...
    ta.geom.delaunay = function(n) {
        ...
        function i(n) {
            ...
            w > S ? y = d + w : m = v + S;
            var k = su();
            if (k.add = function(n) { i(k, n, +M(n, ++g), +x(n, g), v, d, m, y) }, k.visit = function(n) { fu(n, k, v, d, m, y) }, k.find = function(n) {
    ...
    ta.layout.hierarchy = function() {
        ...
        function n(o) {
            ...
            return null != e && v.sort(e === pl ? function(n, t) {
                ...
                return e(o[n], o[t])
            }), v.forEach(function(n) { d[n] = { data: o[n], value: a = l[n], startAngle: s, endAngle: s += a * p + g, padAngle: h } }), d
        }
        var t = Number,
            e = pl,
            r = 0,
    ...
    Pl.call = _a.call, Pl.empty = _a.empty, Pl.node = _a.node, Pl.size = _a.size, ta.transition = function(n, t) {
        ...
        function i(e) {
            return null == e ? u : (e += "", function() {
                ...
                return i !== e && (u = mu(i, e), function(t) { this.style.setProperty(n, u(t), r) })
            })
        }
